...
export default function IOSUpload({ label, onImageSelect, preview, className, required = false }: IOSUploadProps) {
      ...
      >
        {preview ? (
          ...
          >
            ...
            <p className="text-sm font-medium text-neutral-700 mb-1">Upload a photo</p>
            <p className="text-xs text-neutral-500 mb-3">Tap to browse or drag and drop</p>
            <Button variant="outline" size="sm" className="ios-btn-outline text-xs h-9">
              Choose File
            </Button>
          </div>
        )}
