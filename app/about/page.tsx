    ...
    <div className="min-h-full pb-20">
      ...
      <div className="px-5 space-y-4 mb-8">
        {steps.map((step, index) => (
          <div key={index} className="ios-card p-4 animate-fade-up" style={{ animationDelay: `${0.2 + index * 0.1}s` }}>
      ...
      <div className="px-5">
        ...
        >
          ...
          <p className="text-sm text-white/80 mb-4">Join thousands of fashion-forward users today</p>
