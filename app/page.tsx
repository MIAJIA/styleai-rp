...
export default function HomePage() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      if (data.imageUrl) {
        // Animation will complete and then navigate
        setTimeout(() => {
          setShowAnimation(false)
  ...
  const handleAnimationComplete = () => {
    // Animation completed, but we'll handle navigation in handleGenerate
  }
  ...
  return (
    <>
                ...
                <Drawer.Content className="bg-zinc-100 flex flex-col rounded-t-[10px] h-[90%] fixed bottom-0 left-0 right-0 z-50">
                  <div className="p-4 bg-white rounded-t-[10px] flex-1 overflow-y-auto">
                    ...
                    <div className="max-w-md mx-auto">
                      <Drawer.Title className="font-medium mb-4 text-center">Select from My Wardrobe</Drawer.Title>
      ...
      <GenerationAnimation isVisible={showAnimation} onComplete={handleAnimationComplete} />
    </>
  )
}
