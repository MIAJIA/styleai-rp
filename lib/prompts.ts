...
- The outfit must be a complete look.
...
- 2. \`image_prompt\`: A creative, English-only prompt for AI image generator that describes a full-body fashion shot, specifying the mood, lighting, composition, and background that complements the outfit.
- The root JSON object must look like this:
  \`\`\`json
  {
    "outfit_suggestion": { /* ... single outfit object ... */ },
    "image_prompt": "Creative prompt for the outfit visualization..."
  }
  \`\`\`
